            ...
            <div class="rightbox">
                <div class="profile">
                    ...
                    <div class="profile_content">
                        <h3>Name</h3>
                        <span class="input"><?php  echo $info['name']; ?></span>
                        <h3>Username</h3>
                        <span class="input"><?php  echo $info['username']; ?></span>
                        <h3>Email</h3>
                        <span class="input"><?php  echo $info['email']; ?></span>
                        <a href="<?= ROOT_URL ?>edit-profile.php?id=<?= $info['id'] ?>" class="btnedit">Edit</a>
                    </div>
                </div>
            </div>
