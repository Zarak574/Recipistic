...
<!-- HEADER -->
    <header class="header" data-header>
        ...
        <nav class="navbar">
            <ul class="navbar-list">
                ...
                <li><a href="./about.php" class="navbar-link title-small has-state active">About</a></li>
    ...
    <div class="container about">
        <div class="about-header">
            <h2 class="display-medium">About Us</h2>
            <div class="ah-links">
                <a href="index.php" class="display-small">Home /</a>
                <a href="about.php" class="display-small">About</a>
            </div>
        </div>
    </div>
    ...
    <div class="container ab">
        ...
        <div class="ab_content">
                ...
                <h3>Welcome to RECIPISTIC</h3>
                <p>We help people discover what to eat based on personal preferences and data.
                </p>
                <p> Our system of personalized discovery learns you better to serve you better, so the question "what's for dinner?" is answered before it's even asked.
                </p>
...
<section class="section about-1">
    <span class="title-small">About Recipistic</span>
    <div class="section-title display-medium">
            Our mission is to be the smartest and most helpful food platform in existence
    </div>
    <div class="section-text">
        We're fulfilling this mission by improving life in the kitchen for millions of home cooks around the world.
    </div>
</section>
...
<section class="section about-3">
    <div class="about-3-content">
        ...
        <div class="section-text">
            Recipistic's proprietary Food Genome and patent-pending Food Intelligence technology allow us to understand recipes at a deeper level, and recommend recipes to our users based on their diets, allergies, tastes, and more.
        </div>
    </div>
    <div class="about-3-img">
        <img src="assets/images/about-bowl.png" alt="">
    </div>
</section>
